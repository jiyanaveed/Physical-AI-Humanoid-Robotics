...
**Primary Dependencies**: [e.g., FastAPI, Docusaurus or NEEDS CLARIFICATION]  
**Storage**: [if applicable, e.g., PostgreSQL, Vector DB, files or N/A]  
...
# [REMOVE IF UNUSED] Option 4: Textbook & API (when "book/" and "rag_api/" detected)
book/
└── [Docusaurus content]
