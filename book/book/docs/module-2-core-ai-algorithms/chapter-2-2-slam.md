...
description: "Understanding the principles of SLAM, including filter-based and graph-based approaches."
sidebar_position: 2
---
...
<!--
![Graph SLAM Diagram](../assets/graph_slam.svg)
*Illustration of how graph-based SLAM constructs a map and localizes the robot.*
-->
