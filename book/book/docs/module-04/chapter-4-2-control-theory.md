...
3.  **IK and Control Node**:
    ...
    *   For each incoming target pose, it uses your IK solver from Chapter 4.1 to calculate the required joint angles .
    *   It subscribes to the `/joint_states` topic to get the current joint angles .
